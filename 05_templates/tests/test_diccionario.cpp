...
ASSERT_FALSE(d.def("Azul"));
ASSERT_FALSE(d.def("Verde"));
d.definir("Rojo", true);
ASSERT_TRUE(d.def("Rojo"));
ASSERT_FALSE(d.def("Azul"));
ASSERT_FALSE(d.def("Verde"));
ASSERT_EQ(d.obtener("Rojo"), true);
d.definir("Azul", false);
ASSERT_TRUE(d.def("Rojo"));
ASSERT_TRUE(d.def("Azul"));
ASSERT_FALSE(d.def("Verde"));
ASSERT_EQ(d.obtener("Rojo"), true);
ASSERT_EQ(d.obtener("Azul"), false);
d.definir("Rojo", false);
ASSERT_TRUE(d.def("Rojo"));
ASSERT_TRUE(d.def("Azul"));
ASSERT_FALSE(d.def("Verde"));
ASSERT_EQ(d.obtener("Rojo"), false);
ASSERT_EQ(d.obtener("Azul"), false);
}
#endif
